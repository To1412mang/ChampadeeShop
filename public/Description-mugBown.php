    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel-body">
                ...
                <div class="mySlides">
                    <img class="img-slide" src="image/Mug/mugBown-1.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Mug/mugBown-2.png" style="width:100%">
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="panel-body">
                ...
                <p style="font-size: 2vw">แก้วมัคคุณภาพดี ลายเส้นน้องจำปาดีสีน้ำตาล
                    ...
                    เป็นแก้วที่เผา 2 ครั้ง คุณภาพและปริมาณที่ได้จึงสวยงามคงทนโดยจะเห็นได้จากความเงาของแก้ว
                </p>
            </div>
        </div>
