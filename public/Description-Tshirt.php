...
<html lang="th">
<head>
    <title>สื้อยืดลายน้องจำปาดี</title>
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel-body">
                ...
                <div class="mySlides">
                    <img class="img-slide" src="image/T-Shirt/T-shirtMix.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/T-Shirt/T-shirtC.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/T-Shirt/T-shirtV.png" style="width:100%">
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="panel-body">
                ...
                <p style="font-size: 2vw">เสื้อยืดลายเส้นน้องจำปาดี เนื้อผ้าคุณภาพดี สวมใส่สบาย มี 3 สีเท่านั้น มีสีเทา
                    สีขาว และสีเหลือง ลายเสื้อน้องจำปาดีเป็นผลงานการออกแบบลวดลายของคณะวิทยาศาสตร์ มหาวิทยาลัยศิลปากร</p>
            </div>
        </div>
