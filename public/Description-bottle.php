...
<html lang="th">
<head>
    <title>กระบอกน้ำลายน้องจำปาดี</title>
    <meta charset="utf-8">
...
<div class="path">
    ...
    <a href="waterBottle.php" class="P">กระบอกน้ำ > </a>
    <a class="P">ChampaDee Water Bottle</a>
</div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel-body">
                ...
                <div class="mySlides">
                    <img class="img-slide" src="image/Bottle/ChampadeeWATERBOTTLES.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Bottle/bottles-3.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Bottle/bottles-1.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Bottle/bottles-2.png" style="width:100%">
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="panel-body">
                ...
                <p style="font-size: 2vw">กระบอกน้ำพลาสติก 2 สีเท่านั้น มีสีกรม และสีครีม ลายเสื้อน้องจำปาดีเป็นผลงานการออกแบบลวดลายของคณะวิทยาศาสตร์ มหาวิทยาลัยศิลปากร</p>
            </div>
        </div>
        ...
        <div class="col-sm-3 description">
            ...
            <div class="panel-body">
                <h3 class="description">ราคา <b style="font-size: 6vw" class="description">129</b> บาท</h3><br>
