...
<html lang="th">
<head>
    <title>เสื้อคอปกลายน้องจำปาดี</title>
    <meta charset="utf-8">
...
<div class="path">
    ...
    <a href="shirt.php" class="P">เสื้อคอปก > </a>
    <a class="P">ChampaDee Shirt</a>
</div>
    ...
    <div class="row">
        <div class="col-sm-4">
            <div class="panel-body">
                ...
                <div class="mySlides">
                    <img class="img-slide" src="image/Shirt/shirt-1.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Shirt/shirt-2.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Shirt/shirt-3.png" style="width:100%">
                </div>

                <div class="mySlides">
                    <img class="img-slide" src="image/Shirt/shirt-4.png" style="width:100%">
                </div>
            </div>
        ...
        <div class="col-sm-5">
            <div class="panel-body">
                ...
                <p style="font-size: 2vw">เสื้อยืดลายเส้นน้องจำปาดี เนื้อผ้าคุณภาพดี สวมใส่สบาย มี 3 สีเท่านั้น มีสีเทา สีขาว และสีเหลือง  ลายเสื้อน้องจำปาดีเป็นผลงานการออกแบบลวดลายของคณะวิทยาศาสตร์ มหาวิทยาลัยศิลปากร</p>
            </div>
        </div>
        ...
        <div class="col-sm-3 description">
            ...
            <div class="panel-body">
                <h3 class="description">ราคา <b style="font-size: 6vw" class="description">300</b> บาท</h3><br>
